...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://18.222.130.93:9000 \
              -Dsonar.login=101ad69930492893e1fde5cb48fcbd2f567702101"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#cloud-security-devops-team-projects', //update and provide your channel name
